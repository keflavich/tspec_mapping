...
makecube.generate_header(83.809477, -5.3743852144748, naxis1=800, naxis2=800,
...
def filter(fn, suffix='_filtered', clobber=True):
    ...
    #filtlist = [median_filter(data[ii,:,:]-np.percentile(data[ii,:,:],10,axis=0)[np.newaxis
#,:],sk_disk(2))
...
for fn in glob.glob("*_cube.fits"):
